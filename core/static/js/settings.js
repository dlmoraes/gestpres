var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="{{ STATIC_URL|escapejs }}css/theme-default.css"><img src="{{ STATIC_URL|escapejs }}img/themes/default.jpg"/></a>'
            +'<a href="#" data-theme="{{ STATIC_URL|escapejs }}css/theme-brown.css"><img src="{{ STATIC_URL|escapejs }}img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="{{ STATIC_URL|escapejs }}css/theme-blue.css"><img src="{{ STATIC_URL|escapejs }}img/themes/blue.jpg"/></a>'
            +'<a href="#" data-theme="{{ STATIC_URL|escapejs }}css/theme-white.css"><img src="{{ STATIC_URL|escapejs }}img/themes/light.jpg"/></a>'
            +'<a href="#" data-theme="{{ STATIC_URL|escapejs }}css/theme-black.css"><img src="{{ STATIC_URL|escapejs }}img/themes/black.jpg"/></a>'
        +'</div>'
